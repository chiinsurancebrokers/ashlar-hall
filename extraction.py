...
def extract_insurance_data(pdf_bytes: bytes, api_key: str, filename: str = "") -> dict:
    ...
    for attempt in range(MAX_RETRIES):
        try:
            ...
            # ── Exclusions & safety scoring (best-effort — never break extraction) ──
            if _EXCLUSIONS_OK:
                try:
                    ...
                    pass  # exclusions scan is best-effort; never block a successful extraction
